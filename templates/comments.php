	...
	<div class="comments">
		<div class="blog-span-bottom">
			...
			<div class="title-block clearfix">
				<h3 class="h3-body-title"><?php printf(_n('One Response to &ldquo;%2$s&rdquo;', '%1$s Responses to &ldquo;%2$s&rdquo;', get_comments_number(), 'roots'), number_format_i18n(get_comments_number()), get_the_title()); ?></h3>
...
<section id="respond">
  <?php if (comments_open()) : ?>
	...
	<div class="row">
		<div class="blog-span-bottom">
			<div class="title-block clearfix">
				<h3 class="h3-body-title"><?php comment_form_title(__('Leave a Reply', 'roots'), __('Leave a Reply to %s', 'roots')); ?></h3>
				<div class="title-seperator"></div>
			</div>                
		</div>
	</div>
    ...
    <?php else : ?>
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" class="form-wrapper" method="post" id="comment-form" role="form" novalidate>
			...
			<div class="row">
				<div class="col-md-2 col-sm-2 offset2">
					<input type="submit" value="<?php _e('Submit Comment', 'roots'); ?>" class="button large" />
				</div>
			</div>
